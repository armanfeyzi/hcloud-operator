...
1. **Custom Resource Definitions (CRDs)**
   ...
   - Current surface includes `HCloudServer`, `HCloudVolume`, `HCloudLoadBalancer`, `HCloudNetwork`, `HCloudFirewall`, `HCloudPlacementGroup`, and `HCloudPrimaryIP` (see `docs/hcloud-api-coverage.md` for the full matrix).
